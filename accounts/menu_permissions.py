...
# «گزارش‌گیری و آمار» و «حقوق و دستمزد / مرخصی / ساعت کاری» توی MENU_ITEMS پایین هستن —
# یعنی مدیر می‌تونه لینک منو رو براشون نشون/مخفی کنه (بُعد view) — ولی هیچ endpoint ای از
# این چهار صفحه به can_edit_menu وصل نشده و نمی‌شه (تصمیم قطعی مدیر، تأیید شده، نه TODO):
# «گزارش‌گیری» به‌خاطر داده‌ی مالی حساس، و «حقوق/مرخصی/ساعت کاری» طبق تصمیم قدیمی‌تر کارفرما.
# یعنی چک‌باکس «ویرایش» این چهار مورد توی صفحه‌ی تنظیمات دسترسی همیشه بی‌اثره؛ اکشن‌های واقعی
# توشون همیشه فقط برای نقش «مدیر» باز می‌مونن.
