...
urlpatterns = [
    ...
    path('classes/<int:pk>/direct-assign/', DirectAssignClassView.as_view(), name='class_direct_assign'),
    path('classes/<int:pk>/return-to-pending/', ReturnToPendingView.as_view(), name='class_return_to_pending'),
